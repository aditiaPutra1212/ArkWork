            ...
            {mode === "signin" ? (
              <form onSubmit={onSignin} noValidate className="space-y-4">
                ...
                <button
                  ...
                  className="inline-flex w-full items-center justify-center rounded-xl bg-gradient-to-r from-[#16A34A] to-[#15803D] px-4 py-2.5 text-sm font-semibold text-white shadow transition-allduration-150 ease-out hover:from-[#15803D] hover:to-[#166534] hover:shadow-[0_14px_40px_rgba(22,163,74,0.45)] disabled:opacity-60"
                >
                  {siBusy ? (
                    <>
                      <span className="mr-2 inline-block animate-spin">⏳</span>
